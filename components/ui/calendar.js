...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (_jsx(DayPicker, { showOutsideDays: showOutsideDays, className: cn("p-3", className), classNames: {
            ...
            IconLeft: ({ className, ...iconProps }) => (_jsx(ChevronLeft, { className: cn("size-4", className), ...iconProps })),
            IconRight: ({ className, ...iconProps }) => (_jsx(ChevronRight, { className: cn("size-4", className), ...iconProps })),
        }, ...props }));
}
export { Calendar };
